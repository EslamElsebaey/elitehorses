...
$(window).on("scroll" , function (){
  if($(window).scrollTop() > 150){
    ...
    $(".logo img").attr("src" , "images/EliteHorses-logo-light.svg")
    if($(window).width() > 992){
  ...
  if($(window).scrollTop() == 0){
    ...
    if(!$("body").hasClass("pages-body")){
      $(".logo img").attr("src" , "images/EliteHorses-logo-dark.svg")
    }
...
openBtn.on("click", function(){
  ...
  if($(window).width() < 992){
    ...
    if($("body").hasClass("pages-body")){
      ...
      if (currentSrc == "images/EliteHorses-logo-light.svg") {
        $(".logo img").attr("src", "images/EliteHorses-logo-dark.svg");
      } else {
        $(".logo img").attr("src", "images/EliteHorses-logo-light.svg");
      }
    ...
    if($(window).scrollTop() > 100){
      if(!$("body").hasClass("pages-body")){
        ...
        let currentSrc = $(".logo img").attr("src");
        if (currentSrc == "images/EliteHorses-logo-dark.svg") {
          $(".logo img").attr("src", "images/EliteHorses-logo-light.svg");
        } else {
          $(".logo img").attr("src", "images/EliteHorses-logo-dark.svg");
        }
